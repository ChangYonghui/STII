...
%
% Input parameters:
%   STII_REV    Revision of STII = 1, 2, 3, or 4
%   AMP_TYPE    Type of Universal Power Module used, e.g. AMPAQ-PWM
%
% Output parameters:
...
%
function [ Rm, Kt, Km, Pb, Mp, Ml_max, K_AMP, Ms, VMAX_AMP, IMAX_AMP, P_MAX ] = config_STII( STII_REV, AMP_TYPE )
