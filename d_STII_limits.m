...
% ************************************************************************
%
function [ VEL_MAX, F_MAX, ACC_MAX, G_MAX  ] = d_STII_limits( Km, Kt, Mt, Pb, IMAX_AMP, VMAX_AMP )
%
% Maximum angular velocity of motor (rad/s)
W_MAX = VMAX_AMP / Km; % 329 rad/s: less than rated max motor speed of 838 rad/s
% Maximum Linear Velocity (m/s)
VEL_MAX = W_MAX * Pb / ( 2 * pi );
% Maximum force (N)
F_MAX = Kt * IMAX_AMP / Pb;
